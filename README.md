...
A differenza dei dati ufficiali della <a href='https://github.com/pcm-dpc/COVID-19' target='_blank'>Protezione Civile</a>, Regione Lombardia inserisce i risultati dei nuovi tamponi positivi alla data in cui è stato eseguito il prelievo, pertanto le curve qui riportate saranno leggermente differenti. Ciascun grafico è accompagnato da una tabella che riporta le modifiche introdotte dall'ultimo aggiornamento. Da queste tabelle è possibile conoscere la data effettiva del prelievo per i nuovi tamponi positivi.</div>
<hr>
